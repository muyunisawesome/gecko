...
public interface Connection {
    ...
    /**
     * 是否启用可中断写入操作，如果启用，则允许在用户线程写入socket buffer提高数据的发送效率，
     * 但是用户线程的中断可能引起连接断开，需慎重使用。默认不启用。
     *
     * @param writeInterruptibly true——启用 false——不启用
     */
